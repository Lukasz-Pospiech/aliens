...
function ufoLands() {
    document.getElementById("etDIV").style.opacity = "0";
    document.getElementById("ufo").className = "ufoAnimation";
    setTimeout(showEt2, 13000);
     function showEt2() {
        document.getElementById("et2").className = "et2Animation";
    }
    setTimeout(hideEtUfoContainer, 23000);
    function hideEtUfoContainer() {
        document.getElementById("etUfoContainer").style.display = "none";
    }
    setTimeout(showXar, 23000);
    function showXar() {
        document.getElementById("container").style.display = "block";
        document.getElementById("xar").className = "xarAnimation";
        document.getElementById("greenplanet").className = "greenplanetAnimation";
...
function xarTalksForward() {
    ...
    switch (xarTalkSegment) {
        case 1: 
            text1 = "Hello World - Human World. My name is Xar. I come from planet Zentra (a.k.a the Green Planet) located in the constellation Andromeda, 2 million light-years from Earth. The Green Planet is home to a dozen alien races.";
            break;
        case 2: 
            text1 = "Recently one member of your species - a homo sapiens named Lukasz - began recklessly experimeting with CSS and Javascript. He messed up the code so much that it created a vast ripple effect on the other side of this universe.";
            break;
        case 3:
            text1 = "As a result, our planet Zentra’s core has been destabilized, and our species is on the verge of extinction. Nearby planets in our sector are already collapsing. See a collapse for yourself.";
            break;
        case 4: 
            text1 = "I’m the captain of a group of 12 volunteers sent to Earth to track down and hijack Lukasz. We must take him back to our planet because only there can he fix the bugs in his code which created the ripple effect. Check out my crew.";
            break;
        case 5: 
            text1 = "Lukasz is hard to find, he has no friends, doesn’t talk to anyone (only to himself), we can’t reach him. He allegedly made contact with Scrimba – an organization which encourages homo sapiens to learn web development.";
            document.getElementById("crewDIV").style.display = "none";
            showCaveman(); 
            function showCaveman() {
                document.getElementById("caveman").style.display = "block"; 
                document.getElementById("caveman").style.opacity = "0";
                setTimeout(increaseOpacity, 1000);
                function increaseOpacity() {
                    document.getElementById("caveman").style.opacity = "1";
                }
            }
            break;
        case 6: 
            text1 = "Individuals like Lukasz write code which resuls in the destruction of entire star systems! We have reasons to believe that the free HTML/CSS course Lukasz took on Scrimba trigerred him to write code responsible for the current chaos in our galaxy.";
            hideCaveman(); 
            function hideCaveman() {
                document.getElementById("caveman").style.display = "none"; 
            }
            break;
        case 7: 
            text1 = "Our capabilities of doing research here on Earth are limited due to our biological form which we can’t morph in this dimension. We need your help. Help us locate Lukasz. We know he’s hiding somewhere in the tropical zone of your planet.";
            break;
        case 8: 
            text1 = "We’ve created this website to provide you with the only intel we’ve got – the leftovers of Lukasz's experiments with web development, which you'll find in the menu section. Perhaps these pages that Lukasz left will give you some clue as to where he might be located.";
            break;
        case 9: 
            text1 = "He must be hiding there somewhere deep in a tropical jungle, still messing around with code. If you happen to contact him, tell him that we’re not leaving Earth until he surrenders to us. Warn him that, if necessary, we will take him by force.";
            break;
        case 10: 
            text1 = "Now go to menu and explore. End of message. Thank you.";
            break;
    }

    let text1Array = text1.split(' ');
    text1Array = text1Array.map(word => {
        return word === "collapse" ? `<span onclick="showExplosion()" style="color:yellow">${word} </span>` : 
        word === "crew." ? `<span onclick="showCrew()" style="color:yellow">${word} </span>` :
        `<span>${word} </span>`;
    });
